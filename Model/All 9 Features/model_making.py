...
joblib.dump(dt, 'Model/All 9 Features/decisionTree.pkl')
joblib.dump(knn, 'Model/All 9 Features/knn.pkl')
joblib.dump(nb, 'Model/All 9 Features/naivebayes.pkl')
joblib.dump(svm, 'Model/All 9 Features/svm.pkl')