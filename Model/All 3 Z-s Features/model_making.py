...
features = merged[['zpos_mean', 'zvel_mean', 'zacc_mean', 'zpos_var', 'zvel_var', 'zacc_var']]
X = features.values
...
joblib.dump(dt, 'Model/All 3 Z-s Features/decisionTree.pkl')
joblib.dump(knn, 'Model/All 3 Z-s Features/knn.pkl')
joblib.dump(nb, 'Model/All 3 Z-s Features/naivebayes.pkl')
joblib.dump(svm, 'Model/All 3 Z-s Features/svm.pkl')